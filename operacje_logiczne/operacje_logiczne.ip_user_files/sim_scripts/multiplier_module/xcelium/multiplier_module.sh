...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.multiplier_module
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.multiplier_module -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/marcin-zub/operacje_logiczne/operacje_logiczne.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log multiplier_module_sc.so .tmp_log xcelium_lib waves.shm c.obj)
