...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xbip_utils_v3_0_11 -L xbip_pipe_v3_0_7 -L xbip_bram18k_v3_0_7 -L mult_gen_v12_0_19 -L xil_defaultlib -L secureip -L xpm --snapshot multiplier_module xil_defaultlib.multiplier_module -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim multiplier_module -key {Behavioral:sim_1:Functional:multiplier_module} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb multiplier_module.wdb xsim.dir libdpi.so)
