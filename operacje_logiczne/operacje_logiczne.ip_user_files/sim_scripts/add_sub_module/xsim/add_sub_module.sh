...
#
# Script generated by Vivado on Mon Apr 15 13:27:10 CEST 2024
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : add_sub_module.sh
...
#
# Usage        : add_sub_module.sh
#                add_sub_module.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                add_sub_module.sh [-reset_run]
#                add_sub_module.sh [-reset_log]
#                add_sub_module.sh [-help]
#
...
# script info
echo -e "add_sub_module.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./add_sub_module.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xbip_utils_v3_0_11 -L c_reg_fd_v12_0_7 -L xbip_dsp48_wrapper_v3_0_5 -L xbip_pipe_v3_0_7 -L xbip_dsp48_addsub_v3_0_7 -L xbip_addsub_v3_0_7 -L c_addsub_v12_0_16 -L xil_defaultlib -L secureip -L xpm --snapshot add_sub_module xil_defaultlib.add_sub_module -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim add_sub_module -key {Behavioral:sim_1:Functional:add_sub_module} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/marcin/tools/Vivado/2023.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb add_sub_module.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./add_sub_module.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: add_sub_module.sh [-help]\n\
Usage: add_sub_module.sh [-step]\n\
Usage: add_sub_module.sh [-lib_map_path]\n\
Usage: add_sub_module.sh [-reset_run]\n\
Usage: add_sub_module.sh [-reset_log]\n\
Usage: add_sub_module.sh [-keep_index]\n\
Usage: add_sub_module.sh [-noclean_files]\n\n\
