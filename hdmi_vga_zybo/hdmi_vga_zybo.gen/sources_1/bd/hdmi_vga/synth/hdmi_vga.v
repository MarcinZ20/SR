...
module hdmi_vga
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:iic:1.0 hdmi_inn_ddc SCL_I" *) input hdmi_inn_ddc_scl_i;
  (* X_INTERFACE_INFO = "xilinx.com:interface:iic:1.0 hdmi_inn_ddc SCL_O" *) output hdmi_inn_ddc_scl_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:iic:1.0 hdmi_inn_ddc SCL_T" *) output hdmi_inn_ddc_scl_t;
  (* X_INTERFACE_INFO = "xilinx.com:interface:iic:1.0 hdmi_inn_ddc SDA_I" *) input hdmi_inn_ddc_sda_i;
  (* X_INTERFACE_INFO = "xilinx.com:interface:iic:1.0 hdmi_inn_ddc SDA_O" *) output hdmi_inn_ddc_sda_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:iic:1.0 hdmi_inn_ddc SDA_T" *) output hdmi_inn_ddc_sda_t;
  ...
  assign dvi2rgb_0_DDC_SCL_I = hdmi_inn_ddc_scl_i;
  assign dvi2rgb_0_DDC_SDA_I = hdmi_inn_ddc_sda_i;
  assign hdmi_hdp[0] = xlconstant_0_dout;
  ...
  assign hdmi_inn_ddc_scl_o = dvi2rgb_0_DDC_SCL_O;
  assign hdmi_inn_ddc_scl_t = dvi2rgb_0_DDC_SCL_T;
  assign hdmi_inn_ddc_sda_o = dvi2rgb_0_DDC_SDA_O;
  assign hdmi_inn_ddc_sda_t = dvi2rgb_0_DDC_SDA_T;
